...
if ($_POST['type'] == 'change_name') {
        ...
        <select size="4" name="change_economic_laws">
            <option value="0">Не разрешать</option>
...
if (isset($_POST['submit_2'])) {
    ...
    echo '<div class="block"> Закон принаят на рассмотрение</div>';
}
