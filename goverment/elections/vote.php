...
switch ($type) {
    case 1:
        ...
        if ($elec_sql == 0) {
            echo '<div class="block-up">Данного кандидата не существует</div><div class="a-down"><a onclick="history.back()">Назад</a></div>';
            exit;
        }
        ...
        if ($user['vote'] == 1) {
            echo '<div class="block-up">Вы уже отдали свой голос</div><div class="a-down"><a onclick="history.back()">Назад</a></div>';
            exit;
        }
...
echo '<div class="block-up">Вы проголосовали</div><div class="a-down"><a onclick="history.back()">Назад</a></div>';
